...
function Skills({ imagsrc }) {
  ...
  return (
    <div
      className=" bg-white dark:bg-[url('../src/assets/images/bg_night.jpg')]  text-black dark:text-white h-auto font-Rampart"
      id="skills"
    >
        ...
        <div className=" grid md:grid-cols-2 md:gap-16 sm:grid-cols-1 sm:gap-10">
          ...
          >
            <p>
              ...
              passion for programming. I am passionate about delivering
              solutions that add to people's lives and at the same time
              challenge me. Improved my skills as a Front-End and Back-End
              developer.
            </p>
            <p className="pt-10 font-bold text-primary-400">
